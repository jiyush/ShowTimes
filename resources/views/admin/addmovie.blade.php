...
<div class="content-wrapper">
	<div class="container-fluid">
		<div class="card-body">
		<form action="{{ url('/admin/movie/insert') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
			{{ csrf_field() }}
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					...
					<select class="custom-select col-md-3" name="hour" >
                      ...
                      <select class="custom-select col-md-3" name="minut">
                      		<option value="" selected disabled> Select Minut</option>
                      		<option value="1">1</option>
                      		<option value="2">2</option>
                      		<option value="3">3</option>
                      		<option value="4">4</option>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="text" name="tailer_link" class="form-control">
				</div>
			</div>
			<div class="form-row">
				<div class="form-group col-md-6">
